...
#Variable setup for the beginning of the game.
x = 0
y = 0
inventory = []
guardAlive = True
...
#Defining all the smaller functions.
def clear():
...
def gameOver():
    ...
    if deathNumber == 6:
        print('')
        print('Needless to say, you are dead.')
        print('Game Over.')
        print('')
    else:
        print('')
...
def gameLoop():
    ...
    while True:
        ...
        getInput()
        if userInput == 'die' or userInput == 'suicide' or userInput == 'commit suicide' or userInput == 'commit die' or userInput == 'kill self' or userInput == 'kill myself':
            deathNumber = 0
            print('...')
            time.sleep(2)
            print('')
            ...
            if x == 0 and y == 0:
                ...
                actionText = 'East does not exist in this realm.'
            ...
            if x == 80 and y == 80 and guardAlive == False:
                ...
                if deathCount == 7:
                    ...
                    print('You found ' + str(deathCount) + ' out of 7 unique death messages!')
                print('')
                break
            elif x == 80 and y == 80 and guardAlive == True:
                deathNumber = 1
            ...
            if x == 0 and y == -1:
                ...
                print('Really? Ok.')
                print('')
                print('You fall off the edge, into the pit, and die an excruciatingly painful death.')
                gameOver()
                break
            else:
            ...
            load()
        elif userInput == 'lose' or userInput == 'lose game':
            deathNumber = 3
            print('Sure, why not?')
            time.sleep(2)
            print('')
            ...
            time.sleep(1)
            print('')
            print('Due to the fact that the game has been lost, you cease to exist.')
            gameOver()
            break
        elif userInput == 'north' or userInput == 'n' or userInput == 'go north':
            if x == 0 and y == 0:
                y = 1
                actionText = ''
            elif x == 0 and y == 1:
                ...
                actionText = 'North does not exist in this realm.'
            ...
            if x == 0 and y == 0:
                ...
                print('Really? Ok.')
                print('')
                print('You walk to the south, fall off the edge, into the pit, and die an excruciatingly painful death.')
                gameOver()
                break
            elif x == 80 and y == 80:
                actionText = 'South does not exist in this realm.'
            ...
            if x == 0 and y == 0:
                ...
                actionText = 'West does not exist in this realm.'
        elif userInput == 'win' or userInput == 'win game':
            deathNumber = 6
            actionText = ''
            clear()
            printHeader()
            ...
            typeAnything()
            printHeader()
            print('Your business complete, you trancend the realm of the game and exit it completley.')
            typeAnything()
            printHeader()
            print('You ascend higher and higher.')
            typeAnything()
            printHeader()
            print('You suddenly realize that you don\'t have the legis.')
            typeAnything()
            printHeader()
            print('You cannot survive outside of the game without the legis.')
            typeAnything()
            printHeader()
            print('You begin to desintegrate.')
            typeAnything()
            printHeader()
            print('Your body breaks off of you in all directions.')
            typeAnything()
            printHeader()
            print('Your soul ceases to exist.')
            typeAnything()
            printHeader()
            gameOver()
            break
